...
Dialog.Panel = ({ children, className, as = "div", ...props }) => {
...
Dialog.Title = ({ children, className, as = "div", ...props }) => {
  return (
...
Dialog.Description = ({ children, className, as = "div", ...props }) => {
  return (
...
Dialog.Footer = ({ children, className, as, ...props }) => {
